...
This list describes equipment for use by Interplanetary Marine Sciences Sampler
...
- LiDAR Point Cloud Vision Mode

  (Generates a dynamic point cloud. Data is also used to update the Dynamic Path
  Map when using this Vision Mode)

- EMERGENCIES ONLY: High Exposure Vision Mode

  WARNING: May cause HEADACHES and/or DISORIENTATION due to delayed vision,
  artifacting, or blurry images.

  (In this Vision Mode, visual latency is doubled. Increased exposure allows
  improved visibility, for use when other environmental illumination systems are
  not available.)

- Tri-Angle Pulse-Headlight
...
- Dual-Mode Comm Unit (Hydrophone + Hydroacoustic Speaker pair)
  ...
  (In Passive mode, the Hydroacoustic Speaker is disabled.)

  (In Active mode, the Hydroacoustic Speaker is enabled, allowing for cross-unit
  communication)
